...
class Hawkes(object):
    ...
    def __init__(self, timestamps, decay_factor, config, event_category = 'A'):
        self.timestamps = timestamps
        self.event_category = event_category
        self.decay_factor = decay_factor
        if self.event_category == 'A':
            self.pred_realizations_period = config.pred_realizations_period_A
            self.pred_start_time = config.pred_start_time_A
            self.real_network_end_time = config.real_network_end_time_A
        elif self.event_category == 'B':
            self.pred_realizations_period = config.pred_realizations_period_B
            self.pred_start_time = config.pred_start_time_B
            self.real_network_end_time = config.real_network_end_time_B

        elif self.event_category == 'C':
            self.pred_realizations_period = config.pred_realizations_period_C
            self.pred_start_time = config.pred_start_time_C
            self.real_network_end_time = config.real_network_end_time_C
